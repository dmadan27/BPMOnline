	...
	return {
        ...
        methods: {
            ...
            onChangeDate: function() {
                ...
                // set date ke field
                this.set("UsrLatihanDateGetDate", newDate.month+"/"+newDate.date+"/"+newDate.year);

                this.set("UsrLatihanDateGetDay", "Hari Ke-"+newDate.day); // get tgl
             ...
             * @return text month sesuai dgn pilihan english or not
             */
             ...
             * @param date {object} berupa object date js
             * @param english {boolean} default true, jika true maka english, false indo
             * @return text day sesuai dgn pilihan english or not
             */
